...
!(function (a) {
    ...
    if (f) {
        ...
        g && (b = parseFloat(g[1])),
            (g = /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(e)),
            g && (b = parseFloat(g[1]));
    }
    var h = /Edge\/\d+/.test(e),
        i = !!window.CodeMirror;
    if (!i && c)
        if ("function" == typeof __webpack_require__)
            ...
            if (void 0 !== require.resolve)
                ...
                void 0 !== require.specified && (i = require.specified("codemirror"));
    var j =
                    ...
                    return a.length
                        ? e(a).reduce(
                            function (a, b) {
                                var e = c(a);
                                return (
                                    d(c(e), b) ? (e[e.length] = b) : (a[a.length] = [b]), a
                                );
                            },
                            [[b(a)]]
                        )
        ...
        o = (function () {
            var b = function (b) {
                ...
                g = function (a) {
                    return (
                        a &&
                        /^BR|^IMG|^HR|^IFRAME|^BUTTON|^INPUT/.test(a.nodeName.toUpperCase())
                    );
                },
                h = function (a) {
                    return (
                        !b(a) && a && /^DIV|^P|^LI|^H[1-7]/.test(a.nodeName.toUpperCase())
                    );
                },
                i = function (a) {
                ...
                H = function (a) {
                    ...
                    return (
                        0 === b ||
                        (!e(a) && 1 === b && a.innerHTML === F) ||
                        !(!m.all(a.childNodes, e) || "" !== a.innerHTML)
                    );
                },
                I = function (a) {
                ...
                ba = function (a, c) {
                    ...
                    if (0 === a.offset) {
                        ...
                        aa(a.node)
                            ? ((d = a.node.childNodes[a.offset - 1]), (e = G(d)))
                            : ((d = a.node), (e = c ? 0 : a.offset - 1));
                ...
                ca = function (a, c) {
                    ...
                    if (G(a.node) === a.offset) {
                        ...
                        aa(a.node)
                            ? ((d = a.node.childNodes[a.offset]), (e = 0))
                            : ((d = a.node), (e = c ? G(a.node) : a.offset + 1));
                    return { node: d, offset: e };
                },
                da = function (a, b) {
                    ...
                    return d.length
                        ? 1 === d.length
                            ...
                            : d.reduce(function (a, d) {
                                return (
                                    a === b.node && (a = la(b, c)),
                                    la({ node: d, offset: a ? o.position(a) : G(d) }, c)
                                );
                            })
                        : null;
                },
                na = function (a, b) {
                    ...
                    var i =
                        c &&
                        ma(c, a, { isSkipPaddingBlankHTML: b, isNotSplitEdgePoint: b });
                    return (
                        i || d !== a.node || (i = a.node.childNodes[a.offset]),
                        { rightNode: i, container: d }
                    );
                },
                oa = function (a) {
        ...
        p = function (b, c) {
            ...
            return (
                ...
                (this.initialize = function () {
                    return (
                        (this.layoutInfo = e.createLayout(b, c)),
                        this._initialize(),
                        b.hide(),
                        this
                    );
                ...
                (this.destroy = function () {
                    this._destroy(),
                        b.removeData("summernote"),
                        e.removeLayout(b, this.layoutInfo);
                }),
                (this.reset = function () {
                    var a = d.isDisabled();
                    this.code(o.emptyPara),
                        this._destroy(),
                        this._initialize(),
                        a && d.disable();
                }),
                ...
                (this.code = function (a) {
                    ...
                    c ? this.layoutInfo.codable.val(a) : this.layoutInfo.editable.html(a),
                        b.val(a),
                ...
                (this.initializeModule = function (a) {
                    ...
                    (c.shouldInitialize = c.shouldInitialize || l.ok),
                        c.shouldInitialize() &&
                        (c.initialize && c.initialize(),
                            c.events && o.attachEvents(b, c.events));
                }),
                ...
                (this.removeModule = function (a) {
                    var c = this.modules[a];
                    c.shouldInitialize() &&
                        (c.events && o.detachEvents(b, c.events), c.destroy && c.destroy()),
                ...
                (this.removeMemo = function (a) {
                    this.memos[a] && this.memos[a].destroy && this.memos[a].destroy(),
                        delete this.memos[a];
                }),
                (this.createInvokeHandlerAndUpdateState = function (a, b) {
                    return function (c) {
                        d.createInvokeHandler(a, b)(c),
                            d.invoke("buttons.updateCurrentStyle");
                    };
                }),
            ...
            (e = a.extend({}, a.summernote.options, e)),
                ...
                this.each(function (b, c) {
                    ...
                    if (!d.data("summernote")) {
                        var f = new p(d, e);
                        d.data("summernote", f),
                            d.data("summernote").triggerEvent("init", f.layoutInfo);
                    }
                });
            var f = this.first();
            if (f.length) {
    ...
    var q = function (b, c, d, e) {
        this.render = function (f) {
            ...
            return (
                e && e(g, d), d && d.callback && d.callback(g), f && f.append(g), g
            );
        };
    },
        r = {
        ...
        t = r.create('<div class="note-toolbar panel-heading"/>'),
        ...
        E = r.create('<div class="note-color-palette"/>', function (a, b) {
            for (var c = [], d = 0, e = b.colors.length; d < e; d++) {
                for (
                    var f = b.eventName, g = b.colors[d], h = [], i = 0, j = g.length;
                    i < j;
                    i++
                ) {
                    var k = g[i];
        ...
        H = r.create('<div class="checkbox"></div>', function (a, b) {
            a.html(
                [
                    " <label" + (b.id ? ' for="' + b.id + '"' : "") + ">",
                    ' <input type="checkbox"' + (b.id ? ' id="' + b.id + '"' : ""),
                    (b.checked ? " checked" : "") + "/>",
                    b.text ? b.text : "",
                    "</label>",
                ].join("")
        ...
        J = {
            ...
            createLayout: function (a, b) {
                ...
                var c = (
                    b.airMode
                        ? J.airEditor([J.editingArea([J.airEditable()])])
                        : J.editor([
                            J.toolbar(),
                            J.editingArea([J.codable(), J.editable()]),
                            J.statusbar(),
                        ])
                ).render();
                return (
    ...
    var K = (function () {
        ...
        return {
            isEdit: function (b) {
                return m.contains(
                    [a.BACKSPACE, a.TAB, a.ENTER, a.SPACE, a.DELETE],
                    b
                );
            },
            isMove: function (b) {
        ...
        L = (function () {
            var b = function (a, b) {
                ...
                for (c = 0; c < g.length; c++)
                    if (!o.isText(g[c])) {
                        if (
                            (f.moveToElementText(g[c]),
                                f.compareEndPoints("StartToStart", a) >= 0)
                        )
                            break;
                        d = g[c];
                    }
                if (0 !== c && o.isText(g[c - 1])) {
                    ...
                    h.moveToElementText(d || e),
                        h.collapse(!d),
                        (i = d ? d.nextSibling : e.firstChild);
                    var j = a.duplicate();
                    ...
                    for (
                        ...
                        (k -= i.nodeValue.length), (i = i.nextSibling);
                    i.nodeValue;
                    b &&
                        i.nextSibling &&
                        o.isText(i.nextSibling) &&
                ...
                d = function (b, e, f, g) {
                    ...
                    (this.getPoints = function () {
                        ...
                        (this.scrollIntoView = function (b) {
                            var c = a(b).height();
                            return (
                                b.scrollTop + c < this.sc.offsetTop &&
                                (b.scrollTop += Math.abs(
                                    b.scrollTop + c - this.sc.offsetTop
                                )),
                                this
                            );
                        ...
                        (this.normalize = function () {
                            var a = function (a, b) {
                                ...
                                if (
                                    ((o.isLeftEdgePointOf(a, c) ||
                                        o.isVoid(o.prevPoint(a).node)) &&
                                        !b) ||
                                    ((o.isRightEdgePointOf(a, c) ||
                                        o.isVoid(o.nextPoint(a).node)) &&
                                        b)
                                ) {
                                ...
                                return (
                                    (b
                                        ? o.nextPointUntil(o.nextPoint(a), o.isVisiblePoint)
                                        : o.prevPointUntil(o.prevPoint(a), o.isVisiblePoint)) || a
                                );
                            },
                                ...
                                o.walkPoint(
                                    ...
                                    function (b) {
                                        if (!o.isEditable(b.node)) {
                                            var e;
                                            d
                                                ? (o.isLeftEdgePoint(b) && h.push(b.node),
                                                    o.isRightEdgePoint(b) &&
                                                    m.contains(h, b.node) &&
                                                    (e = b.node))
                                                : (e = c ? o.ancestor(b.node, a) : b.node),
                                                e && a(e) && g.push(e);
                                        }
                                    },
                                    !0
                        ...
                        (this.expand = function (a) {
                            ...
                            return (
                                c && ((i.sc = c), (i.so = 0)),
                                h && ((i.ec = h), (i.eo = o.nodeLength(h))),
                                new d(i.sc, i.so, i.ec, i.eo)
                            );
                        }),
                        ...
                        (this.splitText = function () {
                            ...
                            return (
                                o.isText(f) &&
                                !o.isEdgePoint(this.getEndPoint()) &&
                                f.splitText(g),
                                o.isText(b) &&
                                !o.isEdgePoint(this.getStartPoint()) &&
                                ((c.sc = b.splitText(e)),
                                    (c.so = 0),
                                    a && ((c.ec = c.sc), (c.eo = g - e))),
                        ...
                        (this.deleteContents = function () {
                            ...
                            return (
                                a.each(c, function (a, b) {
                                    var c = b.parentNode;
                                    e.node !== c && 1 === o.nodeLength(c) && f.push(c),
                                        o.remove(b, !1);
                                }),
                    ...
                    (this.isOnEditable = i(o.isEditable)),
                        ...
                        (this.wrapBodyInlineWithPara = function () {
                            if (o.isBodyContainer(b) && o.isEmpty(b))
                                return (
                                    (b.innerHTML = o.emptyPara),
                                    new d(b.firstChild, 0, b.firstChild, 0)
                                );
                            ...
                            if (o.isInline(a.sc)) {
                                ...
                                (c = m.last(e)),
                                    o.isInline(c) ||
                                    (c = e[e.length - 2] || a.sc.childNodes[a.so]);
                            } else c = a.sc.childNodes[a.so > 0 ? a.so - 1 : 0];
                            var f = o.listPrev(c, o.isParaInline).reverse();
                            if (
                                ((f = f.concat(o.listNext(c.nextSibling, o.isParaInline))),
                                    f.length)
                            ) {
                        ...
                        (this.insertNode = function (a) {
                            ...
                            return (
                                c.rightNode
                                    ? c.rightNode.parentNode.insertBefore(a, c.rightNode)
                        ...
                        (this.bookmark = function (a) {
                            return {
                                s: { path: o.makeOffsetPath(a, b), offset: e },
                                e: { path: o.makeOffsetPath(a, f), offset: g },
                            };
                        }),
            ...
            return {
                create: function (a, b, c, e) {
                    ...
                    return f || 1 !== arguments.length
                        ...
                        : ((f = this.createFromNode(arguments[0])),
                            f.collapse(o.emptyPara === arguments[0].innerHTML));
                },
                createFromSelection: function () {
                    ...
                    if (k.isW3CRangeSupport) {
                        ...
                        o.isText(m.node) &&
                            o.isLeftEdgePoint(m) &&
                            o.isTextNode(n.node) &&
                            o.isRightEdgePoint(n) &&
                            n.node.nextSibling === m.node &&
                            (m = n),
                            (a = m.cont),
                            (c = m.offset),
                            (e = n.cont),
                ...
                createFromNode: function (a) {
                    ...
                    return (
                        ...
                        o.isBR(d)
                            ? ((e = o.listPrev(d).length - 1), (d = d.parentNode))
                            : o.isVoid(d) && ((e = o.listPrev(d).length), (d = d.parentNode)),
                        this.create(b, c, d, e)
                    );
                },
            ...
            (this.fromNode = function (a) {
                ...
                (this.current = function (b) {
                    ...
                    try {
                        d = a.extend(d, {
                            ...
                            "font-strikethrough": document.queryCommandState("strikethrough")
                                ...
                                : "normal",
                            "font-family":
                                document.queryCommandValue("fontname") || d["font-family"],
                        });
                    } catch (a) { }
                    if (b.isOnList()) {
                    ...
                    if (g && g.style["line-height"])
                        d["line-height"] = g.style.lineHeight;
                    else {
                        var h =
                            parseInt(d["line-height"], 10) / parseInt(d["font-size"], 10);
                        d["line-height"] = h.toFixed(1);
                    }
                    return (
                        (d.anchor = b.isOnAnchor() && o.ancestor(b.sc, o.isAnchor)),
                        (d.ancestors = o.listAncestor(b.sc, o.isEditable)),
                        (d.range = b),
                        d
                    );
                });
            ...
            (this.insertOrderedList = function (a) {
                ...
                (this.toggleList = function (c, d) {
                    ...
                    if (m.find(f, o.isPurePara)) {
                        ...
                        var j = e
                            .nodes(o.isList, { includeAncestor: !0 })
                            .filter(function (b) {
                            ...
                            var f = m.head(e),
                                ...
                                i =
                                    h.childNodes.length > 1
                                        ? o.splitTree(
                                            h,
                                            { node: g.parentNode, offset: o.position(g) + 1 },
                                            { isSkipPaddingBlankHTML: !0 }
                                        )
                                        : null,
                                j = o.splitTree(
                                    h,
                                    { node: f.parentNode, offset: o.position(f) },
                                    { isSkipPaddingBlankHTML: !0 }
                                );
                            (e = c
                                ? o.listDescendant(j, o.isLi)
                                : m.from(j.childNodes).filter(o.isLi)),
        ...
        Q = function () {
            ...
            (this.insertTab = function (a, b) {
                ...
                (this.insertParagraph = function (c) {
                    ...
                    if (f) {
                        if (o.isEmpty(f) && o.isLi(f))
                            return void b.toggleList(f.parentNode.nodeName);
                        if (o.isEmpty(f) && o.isPara(f) && o.isBlockquote(f.parentNode))
                            o.insertAfter(f, f.parentNode), (e = f);
                        else {
                            ...
                            (g = g.concat(o.listDescendant(e, o.isEmptyAnchor))),
                                ...
                                (o.isHeading(e) || o.isPre(e) || o.isCustomStyleTag(e)) &&
                                o.isEmpty(e) &&
                                (e = o.replace(e, "p"));
                        }
                    } else {
                        ...
                        (e = a(o.emptyPara)[0]),
                            h ? d.sc.insertBefore(e, h) : d.sc.appendChild(e);
                    }
        ...
        R = function (a, b, c, d) {
            function e() {
                return !a ||
                    !a.tagName ||
                    ("td" !== a.tagName.toLowerCase() && "th" !== a.tagName.toLowerCase())
                    ? void console.error("Impossible to identify start Cell point.", a)
                    : ((n.colPos = a.cellIndex),
                        a.parentElement &&
                            a.parentElement.tagName &&
                            "tr" === a.parentElement.tagName.toLowerCase()
                            ? void (n.rowPos = a.parentElement.rowIndex)
                            : void console.error(
            ...
            function g(a, b, c, d) {
                return {
                    baseCell: a.baseCell,
                    action: b,
                    virtualTable: { rowIndex: c, cellIndex: d },
                };
            }
            function h(a, b) {
                if (!o[a]) return b;
            ...
            function i(a, b) {
                ...
                var i = b.attributes.rowSpan
                    ? parseInt(b.attributes.rowSpan.value, 10)
                    : 0;
                if (i > 1)
                    for (var k = 1; k < i; k++) {
                        var l = a.rowIndex + k;
                ...
                var m = b.attributes.colSpan
                    ? parseInt(b.attributes.colSpan.value, 10)
                    : 0;
                if (m > 1)
                    for (var o = 1; o < m; o++) {
            ...
            function j(a, b, c, d) {
                a === n.rowPos &&
                    n.colPos >= c.cellIndex &&
                    c.cellIndex <= b &&
                    !d &&
                    n.colPos++;
            }
            function k() {
                for (var a = d.rows, b = 0; b < a.length; b++)
                    for (var c = a[b].cells, e = 0; e < c.length; e++) i(a[b], c[e]);
            }
            function l(a) {
                switch (b) {
                    case R.where.Column:
            ...
            (this.getActionList = function () {
                for (
                    var a = b === R.where.Row ? n.rowPos : -1,
                    d = b === R.where.Column ? n.colPos : -1,
                    e = 0,
                    f = !0;
                    f;
    ...
    (R.where = { Row: 0, Column: 1 }),
        (R.requestAction = { Add: 0, Delete: 1 }),
        (R.resultAction = {
            Ignore: 0,
            SubtractSpanCount: 1,
            RemoveCell: 2,
    ...
    var S,
            ...
            (this.tab = function (a, b) {
                        ...
                        switch (k.action) {
                            ...
                            case R.resultAction.SumSpanCount:
                                if ("top" === c) {
                                    if (
                                        (k.baseCell.parent
                                            ? k.baseCell.closest("tr").rowIndex
                                            : 0) <= e[0].rowIndex
                                    ) {
                                        var m = a("<div></div>")
                                            .append(
                                                a("<td" + l + ">" + o.blank + "</td>").removeAttr(
                                                    "rowspan"
                                                )
                                            )
                                            .html();
                ...
                (this.addCol = function (b, c) {
                    ...
                    for (
                        ...
                        switch (i.action) {
                            case R.resultAction.AddCell:
                                "right" === c
                                    ? a(i.baseCell).after("<td" + j + ">" + o.blank + "</td>")
                                    : a(i.baseCell).before("<td" + j + ">" + o.blank + "</td>");
                                break;
                            case R.resultAction.SumSpanCount:
                                if ("right" === c) {
                ...
                (this.recoverAttributes = function (a) {
                    ...
                    for (var c = a.attributes || [], d = 0; d < c.length; d++)
                        "id" !== c[d].name.toLowerCase() &&
                            c[d].specified &&
                            (b += " " + c[d].name + "='" + c[d].value + "'");
                    return b;
                }),
                            ...
                            switch (h[i].action) {
                                ...
                                case R.resultAction.AddCell:
                                    ...
                                    l &&
                                        (m > 2
                                            ? (m--,
                                                n.insertBefore(p, n.cells[e]),
                                                n.cells[e].setAttribute("rowSpan", m),
                                                (n.cells[e].innerHTML = ""))
                                            : 2 === m &&
                                            (n.insertBefore(p, n.cells[e]),
                                                n.cells[e].removeAttribute("rowSpan"),
                                                (n.cells[e].innerHTML = "")));
                                    continue;
                            ...
                            switch (g[h].action) {
                                ...
                                case R.resultAction.SubtractSpanCount:
                                    ...
                                    if (j) {
                                        ...
                                        k > 2
                                            ? (k--,
                                                i.setAttribute("colSpan", k),
                                                i.cellIndex === e && (i.innerHTML = ""))
                                            : 2 === k &&
                                            (i.removeAttribute("colSpan"),
                                                i.cellIndex === e && (i.innerHTML = ""));
                                    }
                                    continue;
                                case R.resultAction.RemoveCell:
                ...
                (this.createTable = function (b, c, d) {
                    for (var e, f = [], g = 0; g < b; g++)
                        f.push("<td>" + o.blank + "</td>");
                    e = f.join("");
        ...
        U = function (b) {
            ...
            (this.initialize = function () {
                f
                    .on("keydown", function (a) {
                        a.keyCode === K.code.ENTER && b.triggerEvent("enter", a),
                            b.triggerEvent("keydown", a),
                            a.isDefaultPrevented() ||
                            (g.shortcuts
                                ? c.handleKeyMap(a)
                                : c.preventDefaultEditableShortCuts(a));
                    })
                    .on("keyup", function (a) {
                ...
                f.on(
                    ...
                    g.airMode ||
                    (g.width && e.outerWidth(g.width),
                        g.height && f.outerHeight(g.height),
                        g.maxHeight && f.css("max-height", g.maxHeight),
                        g.minHeight && f.css("min-height", g.minHeight)),
                    s.recordUndo();
            }),
                (this.destroy = function () {
                    f.off();
                ...
                (this.handleKeyMap = function (a) {
                    var c = g.keyMap[k.isMac ? "mac" : "pc"],
                        d = [];
                    a.metaKey && d.push("CMD"),
                        a.ctrlKey && !a.altKey && d.push("CTRL"),
                        a.shiftKey && d.push("SHIFT");
                    var e = K.nameFromCode[a.keyCode];
                    e && d.push(e);
                    var f = c[d.join("+")];
                    f
                        ? (a.preventDefault(), b.invoke(f))
                        : K.isEdit(a.keyCode) && this.afterCommand();
                }),
                (this.preventDefaultEditableShortCuts = function (a) {
                    (a.ctrlKey || a.metaKey) &&
                        m.contains([66, 73, 85], a.keyCode) &&
                        a.preventDefault();
                }),
                ...
                (this.undo = function () {
                    b.triggerEvent("before.command", f.html()),
                        s.undo(),
                        b.triggerEvent("change", f.html());
                }),
            ...
            (this.tab = function () {
                            ...
                            t(),
                                "function" == typeof c
                                    ...
                                    : ("string" == typeof c && a.attr("data-filename", c),
                                        a.css("width", Math.min(f.width(), a.width()))),
                                a.show(),
                ...
                (this.insertImagesOrCallback = function (a) {
                    g.callbacks.onImageUpload
                        ? b.triggerEvent("image.upload", a)
                        : this.insertImages(a);
                }),
                ...
                (this.getSelectedText = function () {
                    ...
                    return (
                        a.isOnAnchor() &&
                        (a = L.createFromNode(o.ancestor(a.sc, o.isAnchor))),
                        a.toString()
                    );
                }),
            ...
            (this.fontSize = function (b) {
                ...
                if (c && c.isCollapsed()) {
                    var d = n.styleNodes(c),
                        e = m.head(d);
                    a(d).css({ "font-size": b + "px" }),
                        e &&
                        !o.nodeLength(e) &&
                        ((e.innerHTML = o.ZERO_WIDTH_NBSP_CHAR),
                            L.createFromNodeAfter(e.firstChild).select(),
                            f.data("bogus", e));
                ...
                (this.createLink = this.wrapCommand(function (b) {
                    ...
                    a.each(i, function (b, d) {
                        a(d).attr("href", c),
                            e ? a(d).attr("target", "_blank") : a(d).removeAttr("target");
                    });
                ...
                (this.insertTable = this.wrapCommand(function (a) {
                    ...
                    this.createRange()
                        .deleteContents()
                        .insertNode(p.createTable(b[0], b[1], g));
                })),
                ...
                (this.floatMe = this.wrapCommand(function (b) {
                    ...
                    c.toggleClass("note-float-left", "left" === b),
                        c.toggleClass("note-float-right", "right" === b),
                        c.css("float", b);
                })),
        ...
        V = function (b) {
            ...
            (this.events = {
                ...
                (this.destroy = function () {
                    this.needKeydownHook() &&
                        (this.$paste.remove(), (this.$paste = null));
                }),
                (this.pasteByHook = function () {
                    ...
                    if (o.isImg(c) && 0 === d.indexOf("data:")) {
                        ...
                        (h.name = "clipboard.png"),
                            b.invoke("editor.restoreRange"),
                            b.invoke("editor.focus"),
                            b.invoke("editor.insertImagesOrCallback", [h]);
                    } else {
                        var i = a("<div />").html(this.$paste.html()).html();
                        b.invoke("editor.restoreRange"),
                            b.invoke("editor.focus"),
                            i && b.invoke("editor.pasteHTML", i);
                    }
                    this.$paste.empty();
                }),
                (this.pasteByEvent = function (a) {
                    ...
                    if (c && c.items && c.items.length) {
                        ...
                        "file" === d.kind &&
                            -1 !== d.type.indexOf("image/") &&
                            b.invoke("editor.insertImagesOrCallback", [d.getAsFile()]),
                            b.invoke("editor.afterCommand");
                    }
                });
        },
        W = function (b) {
                        ...
                        i
                            .on("drop", function (c) {
                                ...
                                d && d.files && d.files.length
                                    ? (c.preventDefault(),
                                        e.focus(),
                                        b.invoke("editor.insertImagesOrCallback", d.files))
    ...
    var X = function (a) {
        ...
        (this.sync = function () {
            ...
            (this.deactivate = function () {
                ...
                var g = o.value(d, e.prettifyHtml) || o.emptyPara,
                    h = c.html() !== g;
                c.html(g),
                    c.height(e.height ? d.height() : "auto"),
                ...
                d.on("mousedown", function (a) {
                    ...
                    var b = e.offset().top - c.scrollTop(),
                        d = function (a) {
                            ...
                            (c = f.minheight > 0 ? Math.max(c, f.minheight) : c),
                                (c = f.maxHeight > 0 ? Math.min(c, f.maxHeight) : c),
                                e.height(c);
                        };
        ...
        Z = function (b) {
            ...
            (this.resizeTo = function (a) {
                f.css("height", a.h),
                    g.css("height", a.h),
                    g.data("cmeditor") && g.data("cmeditor").setsize(null, a.h);
            }),
                ...
                (this.toggle = function () {
                    d.toggleClass("fullscreen"),
                        this.isFullscreen()
                            ? (f.data("orgHeight", f.css("height")),
                                h.on("resize", this.onResize).trigger("resize"),
                                i.css("overflow", "hidden"))
                            : (h.off("resize", this.onResize),
                                this.resizeTo({ h: f.data("orgHeight") }),
            ...
            (this.events = {
                            ...
                            if (o.isControlSizing(a.target)) {
                                ...
                                var e = c.$handle
                                    ...
                                    h = function (a) {
                                        b.invoke(
                                            "editor.resizeTo",
                                            { x: a.clientX - f.left, y: a.clientY - (f.top - g) },
                                            e,
                                            !a.shiftKey
                                        ),
                                            c.update(e[0]);
                ...
                (this.update = function (c) {
                    ...
                    if ((b.invoke("imagePopover.update", c), d)) {
                        ...
                        var j = i.w + "x" + i.h;
                        e.find(".note-control-selection-info").text(j),
                            b.invoke("editor.saveTarget", c);
                    } else this.hide();
                    return d;
                }),
                (this.hide = function () {
        ...
        _ = function (b) {
            var c = this,
                d =
                    /^([A-Za-z][A-Za-z0-9+-.]*\:[\/\/]?|mailto:[A-Z0-9._%+-]+@)?(www\.)?(.+)$/i;
            (this.events = {
                ...
                (this.replace = function () {
                    if (this.lastWordRange) {
                        ...
                        if (e && (e[1] || e[2])) {
                            ...
                            this.lastWordRange.insertNode(g),
                                (this.lastWordRange = null),
                                b.invoke("editor.focus");
                        }
                    }
        ...
        ba = function (b) {
            ...
            (this.events = {
                ...
                (this.update = function () {
                    var a =
                        !b.invoke("codeview.isActivated") && b.invoke("editor.isEmpty");
        ...
        ca = function (b) {
            var c = this,
                ...
                i = (this.representShortcut = function (a) {
                    ...
                    return f.shortcuts && b
                        ? (k.isMac && (b = b.replace("CMD", "⌘").replace("SHIFT", "⇧")),
                            " (" +
                            (b = b
                                .replace("BACKSLASH", "\\")
                                .replace("SLASH", "/")
            ...
            (this.initialize = function () {
                ...
                (this.isFontInstalled = function (a) {
                    return (
                        c.fontInstalledMap.hasOwnProperty(a) ||
                        (c.fontInstalledMap[a] =
                            k.isFontInstalled(a) || m.contains(f.fontNamesIgnoreCheck, a)),
                        c.fontInstalledMap[a]
                    );
                }),
                                ...
                                d.dropdown({
                                    ...
                                    template: function (a) {
                                        "string" == typeof a &&
                                            (a = {
                                                tag: a,
                                                title: g.style.hasOwnProperty(a) ? g.style[a] : a,
                                            });
                                        var b = a.tag,
                                            c = a.title;
                                        return (
                        ...
                        b.memo("button.underline", function () {
                            return d
                                .button({
                                    ...
                                    click:
                                        b.createInvokeHandlerAndUpdateState("editor.underline"),
                                })
                                .render();
                        }),
                        ...
                        b.memo("button.strikethrough", function () {
                            return d
                                .button({
                                    ...
                                    click: b.createInvokeHandlerAndUpdateState(
                        ...
                        b.memo("button.superscript", function () {
                            return d
                                .button({
                                    ...
                                    click:
                                        b.createInvokeHandlerAndUpdateState("editor.superscript"),
                                })
                                .render();
                        }),
                        b.memo("button.subscript", function () {
                            return d
                                .button({
                                    ...
                                    click:
                                        b.createInvokeHandlerAndUpdateState("editor.subscript"),
                                })
                                .render();
                        }),
                        b.memo("button.fontname", function () {
                            return d
                                .buttonGroup([
                                    d.button({
                                        className: "dropdown-toggle",
                                        contents: d.dropdownButtonContents(
                                    ...
                                    d.dropdownCheck({
                                        ...
                                        template: function (a) {
                                            return (
                                                '<span style="font-family:' + a + '">' + a + "</span>"
                                            );
                                        },
                                        click:
                                            b.createInvokeHandlerAndUpdateState("editor.fontName"),
                                    }),
                                ])
                                .render();
                        }),
                            ...
                            return d
                                .buttonGroup([
                                    ...
                                    d.dropdownCheck({
                                        ...
                                        items: f.fontSizes,
                                        click:
                                            b.createInvokeHandlerAndUpdateState("editor.fontSize"),
                                    }),
                                ])
                                .render();
                        }),
                                    ...
                                    children: [
                                        ...
                                        d.dropdown({
                                            ...
                                            click: function (c) {
                                                ...
                                                if (e && f) {
                                                    var g =
                                                        "backColor" === e ? "background-color" : "color",
                                                        h = d
                                                            .closest(".note-color")
                                                            .find(".note-recent-color"),
                                                        i = d
                            ...
                            return d
                                .buttonGroup([
                                    ...
                                    d.dropdown([
                                        ...
                                        d.buttonGroup({ className: "note-list", children: [m, n] }),
                                    ]),
                                ])
                                .render();
                        }),
                ...
                (this.build = function (a, c) {
                    for (var e = 0, f = c.length; e < f; e++) {
                        for (
                            ...
                            h = g[0],
                            i = g[1],
                            j = d.buttonGroup({ className: "note-" + h }).render(),
                            k = 0,
                            l = i.length;
                            k < l;
                            k++
                ...
                (this.tableMoveHandler = function (b) {
                    ...
                    h.css({ width: k.c + "em", height: k.r + "em" }),
                        ...
                        3 < k.c &&
                        k.c < f.insertTableMaxSize.col &&
                        i.css({ width: k.c + 1 + "em" }),
                        3 < k.r &&
                        k.r < f.insertTableMaxSize.row &&
                        i.css({ height: k.r + 1 + "em" }),
                        e.html(k.c + " x " + k.r);
                });
        },
        da = function (b) {
            ...
            (this.shouldInitialize = function () {
                ...
                (this.initialize = function () {
                    (g.toolbar = g.toolbar || []),
                        g.toolbar.length
                            ? b.invoke("buttons.build", f, g.toolbar)
                            : f.hide(),
                ...
                (this.updateFullscreen = function (a) {
                    c.toggleBtnActive(f.find(".btn-fullscreen"), a),
                        this.changeContainer(a);
                }),
                (this.updateCodeview = function (a) {
                    c.toggleBtnActive(f.find(".btn-codeview"), a),
                        a ? this.deactivate() : this.activate();
                }),
                    ...
                    c =
                        ...
                        (f.disableLinkTarget
                            ...
                            : a("<div/>")
                                ...
                                .html()),
                    h =
                        '<button href="#" class="btn btn-primary note-btn note-btn-primary note-link-btn disabled" disabled>' +
                        g.link.insert +
                        "</button>";
                this.$dialog = d
                    .dialog({
                ...
                (this.initialize = function () {
                    this.$popover = d
                        .popover({
                            ...
                            callback: function (a) {
                                a.find(".popover-content,.note-popover-content").prepend(
            ...
            (this.initialize = function () {
                ...
                if (f.maximumImageFileSize) {
                    var h = Math.floor(Math.log(f.maximumImageFileSize) / Math.log(1024)),
                        i =
                            1 * (f.maximumImageFileSize / Math.pow(1024, h)).toFixed(2) +
                            " " +
                            " KMGTP"[h] +
                            "B";
                ...
                var j =
                    ...
                    k =
                        '<button href="#" class="btn btn-primary note-btn note-btn-primary note-image-btn disabled" disabled>' +
                        g.image.insert +
                        "</button>";
                this.$dialog = d
                    .dialog({
                        ...
                        this.showImageDialog()
                            .then(function (a) {
                                d.hideDialog(c.$dialog),
                                    b.invoke("editor.restoreRange"),
                                    "string" == typeof a
                                        ? b.invoke("editor.insertImage", a)
                                        : b.invoke("editor.insertImagesOrCallback", a);
                            })
                            .fail(function () {
                                b.invoke("editor.restoreRange");
                            });
            ...
            (this.events = {
                ...
                (this.initialize = function () {
                    this.$popover = d
                        ...
                        .appendTo("body");
                    var a = this.$popover.find(".popover-content,.note-popover-content");
                    b.invoke("buttons.build", a, e.popover.table),
                        k.isFF && document.execCommand("enableInlineTableEditing", !1, !1);
                }),
                (this.destroy = function () {
                    this.$popover.remove();
                }),
        ...
        ja = function (b) {
            ...
            (this.initialize = function () {
                var b = f.dialogsInBody ? a(document.body) : e,
                    ...
                    h =
                        '<button href="#" class="btn btn-primary note-btn note-btn-primary  note-video-btn disabled" disabled>' +
                        g.video.insert +
                        "</button>";
                this.$dialog = d
                    .dialog({
                ...
                (this.createVideoNode = function (b) {
                    ...
                    if (e && 11 === e[1].length) {
                        ...
                        c = a(
                            ...
                            .attr(
                                "src",
                                "http://v.qq.com/iframe/player.html?vid=" + A + "&amp;auto=0"
                            );
                    } else {
                        if (!(u || w || y)) return !1;
                        c = a("<video controls>")
                ...
                return Object.keys(c)
                    .map(function (d) {
                        ...
                        return (
                            f
                                .append(
                                    a("<label><kbd>" + d + "</kdb></label>").css({
                                        width: 180,
                                        "margin-right": 10,
                                    })
                                )
                                .append(a("<span/>").html(b.memo("help." + e) || e)),
                            f.html()
                        );
                    })
                    .join("");
        ...
        la = function (b) {
            ...
            (this.events = {
                ...
                "summernote.focusout": function (a, b) {
                    k.isFF ||
                        (b.relatedTarget &&
                            o.ancestor(b.relatedTarget, l.eq(c.$popover[0]))) ||
                        c.hide();
                },
            }),
                (this.shouldInitialize = function () {
            ...
            (this.events = {
                ...
                (this.initialize = function () {
                    (this.lastWordRange = null),
                        ...
                        this.$content.on("click", ".note-hint-item", function () {
                            c.$content.find(".active").removeClass("active"),
                ...
                (this.selectItem = function (a) {
                    this.$content.find(".active").removeClass("active"),
                        ...
                        (this.$content[0].scrollTop =
                            a[0].offsetTop - this.$content.innerHeight() / 2);
                }),
                ...
                (this.replace = function () {
                    ...
                    if (a.length) {
                        ...
                        this.lastWordRange.insertNode(c),
                            ...
                            b.triggerEvent(
                                "change",
                                b.layoutInfo.editable.html(),
                                b.layoutInfo.editable
                            ),
                            b.invoke("editor.focus");
                    }
                }),
                ...
                (this.createItemTemplates = function (b, c) {
                    ...
                    return c.map(function (c, e) {
                        ...
                        return (
                            f.append(d.template ? d.template(c) : c + ""),
                            f.data({ index: b, item: c }),
                            0 === b && 0 === e && f.addClass("active"),
                            f
                        );
                    });
                }),
                (this.handleKeydown = function (a) {
                    this.$popover.is(":visible") &&
                        (a.keyCode === K.code.ENTER
                            ? (a.preventDefault(), this.replace())
                            : a.keyCode === K.code.UP
                                ? (a.preventDefault(), this.moveUp())
                                : a.keyCode === K.code.DOWN &&
                                (a.preventDefault(), this.moveDown()));
                }),
                ...
                (this.createGroup = function (b, d) {
                    ...
                    return (
                        this.searchKeyword(b, d, function (a) {
                            (a = a || []),
                                a.length && (e.html(c.createItemTemplates(b, a)), c.show());
                        }),
                        e
                    );
                }),
                (this.handleKeyup = function (a) {
                    if (m.contains([K.code.ENTER, K.code.UP, K.code.DOWN], a.keyCode)) {
                        if (a.keyCode === K.code.ENTER && this.$popover.is(":visible"))
                            return;
                    } else {
